                    ...
                    <div class="grid grid-cols-1 mt-10 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="col-span-full">
                            ...
                            @enderror
                                                ...
                                                <!-- Driver Name -->
                                                <div class="sm:col-span-3">
                                                    <label for="driver_name" class="block text-sm font-medium leading-6 text-gray-900">Driver Name</label>
                                                    <div class="mt-2">
                                                ...
                                                <!-- Driver Phone -->
                                                <div class="sm:col-span-3">
                                                    <label for="driver_phone" class="block text-sm font-medium leading-6 text-gray-900">Driver Phone</label>
                                                    <div class="mt-2">
                                                ...
                                                <!-- Driver NID -->
                                                <div class="sm:col-span-3">
                                                    <label for="driver_nid" class="block text-sm font-medium leading-6 text-gray-900">Driver NID</label>
                                                    <div class="mt-2">
                                                        <input type="text" name="driver_nid" id="driver_nid"
                                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-pr-400 sm:text-sm sm:leading-6">
                                                    </div>
                                                    @error('driver_nid')
                                                        <span class="text-red-500">{{ $message }}</span>
                                                ...
                                                <!-- Driver Photo -->
                                                <div class="col-span-full">
                                                    <label for="driver_photo" class="block text-sm font-medium leading-6 text-gray-900">Driver Photo</label>
                                                    <div class="flex justify-center px-6 py-10 mt-2 border border-dashed rounded-lg border-gray-900/25">
                                                        <div class="text-center">
                                                            ...
                                                            <div class="flex mt-4 text-sm leading-6 text-gray-600">
                                                                <label for="driver_photo_upload" class="relative font-semibold bg-white rounded-md cursor-pointer text-pr-400 focus-within:outline-none focus-within:ring-2 focus-within:ring-pr-400 focus-within:ring-offset-2 hover:text-pr-400">
                                                                    <span>Upload a file</span>
                                                                    <input id="driver_photo_upload" name="driver_photo" type="file" class="sr-only">
                                                                </label>
                                                                <p class="pl-1">or drag and drop</p>
                                                            </div>
                                                            <p class="text-xs leading-5 text-gray-600">PNG, JPG, GIF up to 10MB</p>
